package com.zek.cryptotracker.crypto.presentation.coin_detail
...
import com.zek.cryptotracker.crypto.presentation.coin_detail.components.InfoCard
import com.zek.cryptotracker.crypto.presentation.coin_list.CoinListState
import com.zek.cryptotracker.crypto.presentation.models.toDisplayableNumber
import com.zek.cryptotracker.ui.theme.greenBackground
            ...
            FlowRow(
                ...
                AnimatedVisibility(
                    ...
                    LineChart(
                        ...
                        selectedDataPoint = selectedCoin,
                        onSelectedDataPoint = { selectedCoin = it },
                        onXLabelWidthChange = {
                            labelWidth = it
                        }
                    )
